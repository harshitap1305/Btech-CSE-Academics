   ...
   e:	31 db                	xor    %ebx,%ebx
{
  ...
  1f:	74 1d                	je     3e <main+0x3e>
  for(i = 0; i < num_children; i++) {
  21:	83 fb 05             	cmp    $0x5,%ebx
  24:	75 eb                	jne    11 <main+0x11>
      while(1); // loop forever
    }
  }
  exit();
  26:	e8 78 02 00 00       	call   2a3 <exit>
      printf(1, "Fork failed\n");
  2b:	50                   	push   %eax
  2c:	50                   	push   %eax
  2d:	68 48 07 00 00       	push   $0x748
  32:	6a 01                	push   $0x1
  34:	e8 07 04 00 00       	call   440 <printf>
      exit();
  39:	e8 65 02 00 00       	call   2a3 <exit>
      printf(1, "Child process %d started with PID %d\n", i+1, getpid());
  3e:	e8 e0 02 00 00       	call   323 <getpid>
  43:	50                   	push   %eax
  44:	53                   	push   %ebx
  45:	68 5c 07 00 00       	push   $0x75c
  4a:	6a 01                	push   $0x1
 ...
 3a8:	89 d1                	mov    %edx,%ecx
{
 ...
 416:	50                   	push   %eax
 417:	56                   	push   %esi
 418:	e8 a6 fe ff ff       	call   2c3 <write>
  while(--i >= 0)
 ...
 449:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 480:	50                   	push   %eax
 481:	57                   	push   %edi
 482:	e8 3c fe ff ff       	call   2c3 <write>
 ...
 4f1:	52                   	push   %edx
 4f2:	57                   	push   %edi
 4f3:	e8 cb fd ff ff       	call   2c3 <write>
        putc(fd, c);
 ...
 59a:	52                   	push   %edx
 59b:	57                   	push   %edi
 59c:	e8 22 fd ff ff       	call   2c3 <write>
        ap++;
 ...
 5c0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5c5:	bb 55 07 00 00       	mov    $0x755,%ebx
...
free(void *ap)
{
 ...
 5d1:	a1 7c 0a 00 00       	mov    0xa7c,%eax
{
 ...
 60f:	5b                   	pop    %ebx
  freep = p;
 610:	a3 7c 0a 00 00       	mov    %eax,0xa7c
}
 615:	5e                   	pop    %esi
 616:	5f                   	pop    %edi
 617:	5d                   	pop    %ebp
 ...
 626:	72 ce                	jb     5f6 <free+0x26>
{
 ...
 647:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 64a:	a3 7c 0a 00 00       	mov    %eax,0xa7c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 15 7c 0a 00 00    	mov    0xa7c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ab:	3b 05 7c 0a 00 00    	cmp    0xa7c,%eax
 ...
 6ce:	e8 fd fe ff ff       	call   5d0 <free>
  return freep;
 6d3:	8b 15 7c 0a 00 00    	mov    0xa7c,%edx
 ...
 717:	0a 00 00 
    base.s.size = 0;
 71a:	b8 80 0a 00 00       	mov    $0xa80,%eax
    base.s.ptr = freep = prevp = &base;
 71f:	c7 05 80 0a 00 00 80 	movl   $0xa80,0xa80
 726:	0a 00 00 
    base.s.size = 0;
 729:	c7 05 84 0a 00 00 00 	movl   $0x0,0xa84
 730:	00 00 00 
    if(p->s.size >= nunits){
