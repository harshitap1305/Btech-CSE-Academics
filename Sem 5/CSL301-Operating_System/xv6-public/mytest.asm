 ...
 419:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 590:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 595:	bb 2e 07 00 00       	mov    $0x72e,%ebx
 ...
 5a1:	a1 2c 0a 00 00       	mov    0xa2c,%eax
{
 ...
 5df:	5b                   	pop    %ebx
  freep = p;
 5e0:	a3 2c 0a 00 00       	mov    %eax,0xa2c
}
 5e5:	5e                   	pop    %esi
 5e6:	5f                   	pop    %edi
 5e7:	5d                   	pop    %ebp
 ...
 5f6:	72 ce                	jb     5c6 <free+0x26>
{
 ...
 617:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 61a:	a3 2c 0a 00 00       	mov    %eax,0xa2c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 639:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 63c:	8b 15 2c 0a 00 00    	mov    0xa2c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 67b:	3b 05 2c 0a 00 00    	cmp    0xa2c,%eax
 ...
 69e:	e8 fd fe ff ff       	call   5a0 <free>
  return freep;
 6a3:	8b 15 2c 0a 00 00    	mov    0xa2c,%edx
 ...
 6f6:	0a 00 00 
    base.s.size = 0;
 6f9:	c7 05 34 0a 00 00 00 	movl   $0x0,0xa34
 700:	00 00 00 
    if(p->s.size >= nunits){
