  ...
  11:	83 39 02             	cmpl   $0x2,(%ecx)
{
  ...
  20:	6a 02                	push   $0x2
  22:	e8 69 04 00 00       	call   490 <printf>
    exit();
  ...
  97:	52                   	push   %edx
  98:	52                   	push   %edx
  99:	68 ac 07 00 00       	push   $0x7ac
  9e:	6a 01                	push   $0x1
  a0:	e8 eb 03 00 00       	call   490 <printf>
    exit();
 ...
 3f8:	89 d1                	mov    %edx,%ecx
{
 ...
 42b:	0f b6 92 50 08 00 00 	movzbl 0x850(%edx),%edx
 ...
 466:	50                   	push   %eax
 467:	56                   	push   %esi
 468:	e8 a6 fe ff ff       	call   313 <write>
  while(--i >= 0)
 ...
 499:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 4d0:	50                   	push   %eax
 4d1:	57                   	push   %edi
 4d2:	e8 3c fe ff ff       	call   313 <write>
 ...
 504:	ff 24 85 f8 07 00 00 	jmp    *0x7f8(,%eax,4)
 ...
 541:	52                   	push   %edx
 542:	57                   	push   %edi
 543:	e8 cb fd ff ff       	call   313 <write>
        putc(fd, c);
 ...
 5ea:	52                   	push   %edx
 5eb:	57                   	push   %edi
 5ec:	e8 22 fd ff ff       	call   313 <write>
        ap++;
 ...
 610:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 615:	bb ee 07 00 00       	mov    $0x7ee,%ebx
 ...
 621:	a1 ec 0a 00 00       	mov    0xaec,%eax
{
 ...
 65f:	5b                   	pop    %ebx
  freep = p;
 660:	a3 ec 0a 00 00       	mov    %eax,0xaec
}
 665:	5e                   	pop    %esi
 666:	5f                   	pop    %edi
 667:	5d                   	pop    %ebp
 ...
 676:	72 ce                	jb     646 <free+0x26>
{
 ...
 697:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 69a:	a3 ec 0a 00 00       	mov    %eax,0xaec
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 15 ec 0a 00 00    	mov    0xaec,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6fb:	3b 05 ec 0a 00 00    	cmp    0xaec,%eax
 701:	75 ed                	jne    6f0 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 703:	83 ec 0c             	sub    $0xc,%esp
 706:	56                   	push   %esi
 707:	e8 6f fc ff ff       	call   37b <sbrk>
  if(p == (char*)-1)
 ...
 71e:	e8 fd fe ff ff       	call   620 <free>
  return freep;
 723:	8b 15 ec 0a 00 00    	mov    0xaec,%edx
 ...
 74c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 74f:	89 15 ec 0a 00 00    	mov    %edx,0xaec
}
 ...
 75f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 760:	c7 05 ec 0a 00 00 f0 	movl   $0xaf0,0xaec
 767:	0a 00 00 
    base.s.size = 0;
 76a:	b8 f0 0a 00 00       	mov    $0xaf0,%eax
    base.s.ptr = freep = prevp = &base;
 76f:	c7 05 f0 0a 00 00 f0 	movl   $0xaf0,0xaf0
 776:	0a 00 00 
    base.s.size = 0;
 779:	c7 05 f4 0a 00 00 00 	movl   $0x0,0xaf4
 780:	00 00 00 
    if(p->s.size >= nunits){
