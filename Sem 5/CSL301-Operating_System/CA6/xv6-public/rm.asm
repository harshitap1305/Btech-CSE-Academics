...
main(int argc, char *argv[])
{
  ...
  69:	6a 02                	push   $0x2
  6b:	e8 f0 03 00 00       	call   460 <printf>
    exit();
 ...
 3c8:	89 d1                	mov    %edx,%ecx
{
 ...
 3fb:	0f b6 92 f4 07 00 00 	movzbl 0x7f4(%edx),%edx
 ...
 469:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 4d4:	ff 24 85 9c 07 00 00 	jmp    *0x79c(,%eax,4)
 ...
 5f1:	a1 a0 0a 00 00       	mov    0xaa0,%eax
{
 ...
 62f:	5b                   	pop    %ebx
  freep = p;
 630:	a3 a0 0a 00 00       	mov    %eax,0xaa0
}
 635:	5e                   	pop    %esi
 636:	5f                   	pop    %edi
 637:	5d                   	pop    %ebp
 ...
 646:	72 ce                	jb     616 <free+0x26>
{
 ...
 667:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 66a:	a3 a0 0a 00 00       	mov    %eax,0xaa0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6cb:	3b 05 a0 0a 00 00    	cmp    0xaa0,%eax
