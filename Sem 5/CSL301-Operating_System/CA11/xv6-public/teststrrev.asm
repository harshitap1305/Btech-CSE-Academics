...
_teststrrev:     file format elf32-i386
...
int main(void) {
  ...
  char buf[32] = "Harshita Patidar";
  15:	c7 45 d8 48 61 72 73 	movl   $0x73726148,-0x28(%ebp)
  printf(1, "Before: %s\n", buf);
  1c:	53                   	push   %ebx
  1d:	68 68 07 00 00       	push   $0x768
  22:	6a 01                	push   $0x1
  char buf[32] = "Harshita Patidar";
  24:	c7 45 dc 68 69 74 61 	movl   $0x61746968,-0x24(%ebp)
  2b:	c7 45 e0 20 50 61 74 	movl   $0x74615020,-0x20(%ebp)
  32:	c7 45 e4 69 64 61 72 	movl   $0x72616469,-0x1c(%ebp)
  39:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
  40:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  47:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  4e:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  printf(1, "Before: %s\n", buf);
  55:	e8 06 04 00 00       	call   460 <printf>
  strrev(buf, strlen(buf));
  5a:	89 1c 24             	mov    %ebx,(%esp)
  5d:	e8 ae 00 00 00       	call   110 <strlen>
  62:	5a                   	pop    %edx
  63:	59                   	pop    %ecx
  64:	50                   	push   %eax
  65:	53                   	push   %ebx
  66:	e8 f8 02 00 00       	call   363 <strrev>
  printf(1, "After: %s\n", buf);
  6b:	83 c4 0c             	add    $0xc,%esp
  6e:	53                   	push   %ebx
  6f:	68 74 07 00 00       	push   $0x774
  74:	6a 01                	push   $0x1
  76:	e8 e5 03 00 00       	call   460 <printf>
  exit();
  7b:	e8 43 02 00 00       	call   2c3 <exit>
 ...
 3c8:	89 d1                	mov    %edx,%ecx
{
 ...
 3fb:	0f b6 92 e0 07 00 00 	movzbl 0x7e0(%edx),%edx
 ...
 436:	50                   	push   %eax
 437:	56                   	push   %esi
 438:	e8 a6 fe ff ff       	call   2e3 <write>
  while(--i >= 0)
 ...
 469:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 4a0:	50                   	push   %eax
 4a1:	57                   	push   %edi
 4a2:	e8 3c fe ff ff       	call   2e3 <write>
 ...
 4d4:	ff 24 85 88 07 00 00 	jmp    *0x788(,%eax,4)
 ...
 511:	52                   	push   %edx
 512:	57                   	push   %edi
 513:	e8 cb fd ff ff       	call   2e3 <write>
        putc(fd, c);
 ...
 5ba:	52                   	push   %edx
 5bb:	57                   	push   %edi
 5bc:	e8 22 fd ff ff       	call   2e3 <write>
        ap++;
 ...
 5e0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5e5:	bb 7f 07 00 00       	mov    $0x77f,%ebx
 ...
 5f1:	a1 80 0a 00 00       	mov    0xa80,%eax
{
 ...
 62f:	5b                   	pop    %ebx
  freep = p;
 630:	a3 80 0a 00 00       	mov    %eax,0xa80
}
 635:	5e                   	pop    %esi
 636:	5f                   	pop    %edi
 637:	5d                   	pop    %ebp
 ...
 646:	72 ce                	jb     616 <free+0x26>
{
 ...
 667:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 66a:	a3 80 0a 00 00       	mov    %eax,0xa80
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 15 80 0a 00 00    	mov    0xa80,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6cb:	3b 05 80 0a 00 00    	cmp    0xa80,%eax
 ...
 6ee:	e8 fd fe ff ff       	call   5f0 <free>
  return freep;
 6f3:	8b 15 80 0a 00 00    	mov    0xa80,%edx
 ...
 72f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 730:	c7 05 80 0a 00 00 84 	movl   $0xa84,0xa80
 737:	0a 00 00 
    base.s.size = 0;
 73a:	b8 84 0a 00 00       	mov    $0xa84,%eax
    base.s.ptr = freep = prevp = &base;
 73f:	c7 05 84 0a 00 00 84 	movl   $0xa84,0xa84
 746:	0a 00 00 
    base.s.size = 0;
 749:	c7 05 88 0a 00 00 00 	movl   $0x0,0xa88
 750:	00 00 00 
    if(p->s.size >= nunits){
