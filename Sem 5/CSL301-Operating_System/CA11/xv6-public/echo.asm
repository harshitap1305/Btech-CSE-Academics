...
000003a3 <twostrike>:
SYSCALL(twostrike)
 3a3:	b8 23 00 00 00       	mov    $0x23,%eax
 3a8:	cd 40                	int    $0x40
 3aa:	c3                   	ret
 ...
 3b8:	89 d1                	mov    %edx,%ecx
{
 ...
 426:	50                   	push   %eax
 427:	56                   	push   %esi
 428:	e8 a6 fe ff ff       	call   2d3 <write>
  while(--i >= 0)
 ...
 459:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 490:	50                   	push   %eax
 491:	57                   	push   %edi
 492:	e8 3c fe ff ff       	call   2d3 <write>
 ...
 501:	52                   	push   %edx
 502:	57                   	push   %edi
 503:	e8 cb fd ff ff       	call   2d3 <write>
        putc(fd, c);
 ...
 5aa:	52                   	push   %edx
 5ab:	57                   	push   %edi
 5ac:	e8 22 fd ff ff       	call   2d3 <write>
        ap++;
 ...
 5e1:	a1 68 0a 00 00       	mov    0xa68,%eax
{
 ...
 61f:	5b                   	pop    %ebx
  freep = p;
 620:	a3 68 0a 00 00       	mov    %eax,0xa68
}
 625:	5e                   	pop    %esi
 626:	5f                   	pop    %edi
 627:	5d                   	pop    %ebp
 ...
 636:	72 ce                	jb     606 <free+0x26>
{
 ...
 657:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 65a:	a3 68 0a 00 00       	mov    %eax,0xa68
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6bb:	3b 05 68 0a 00 00    	cmp    0xa68,%eax
