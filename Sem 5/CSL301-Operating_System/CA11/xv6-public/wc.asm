 ...
 4c8:	89 d1                	mov    %edx,%ecx
{
 ...
 4fb:	0f b6 92 00 09 00 00 	movzbl 0x900(%edx),%edx
 ...
 536:	50                   	push   %eax
 537:	56                   	push   %esi
 538:	e8 a6 fe ff ff       	call   3e3 <write>
  while(--i >= 0)
 ...
 569:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5a0:	50                   	push   %eax
 5a1:	57                   	push   %edi
 5a2:	e8 3c fe ff ff       	call   3e3 <write>
 ...
 5d4:	ff 24 85 a8 08 00 00 	jmp    *0x8a8(,%eax,4)
 ...
 611:	52                   	push   %edx
 612:	57                   	push   %edi
 613:	e8 cb fd ff ff       	call   3e3 <write>
        putc(fd, c);
 ...
 67b:	53                   	push   %ebx
 67c:	57                   	push   %edi
 67d:	e8 61 fd ff ff       	call   3e3 <write>
        while(*s != 0){
 ...
 6ba:	52                   	push   %edx
 6bb:	57                   	push   %edi
 6bc:	e8 22 fd ff ff       	call   3e3 <write>
        ap++;
 ...
 6f1:	a1 e0 0d 00 00       	mov    0xde0,%eax
{
 ...
 72f:	5b                   	pop    %ebx
  freep = p;
 730:	a3 e0 0d 00 00       	mov    %eax,0xde0
}
 735:	5e                   	pop    %esi
 736:	5f                   	pop    %edi
 737:	5d                   	pop    %ebp
 ...
 746:	72 ce                	jb     716 <free+0x26>
{
 ...
 767:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 76a:	a3 e0 0d 00 00       	mov    %eax,0xde0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7cb:	3b 05 e0 0d 00 00    	cmp    0xde0,%eax
