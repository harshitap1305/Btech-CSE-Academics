 ...
 3a8:	89 d1                	mov    %edx,%ecx
{
 ...
 3db:	0f b6 92 bc 07 00 00 	movzbl 0x7bc(%edx),%edx
 ...
 449:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 4b4:	ff 24 85 64 07 00 00 	jmp    *0x764(,%eax,4)
 ...
 5d1:	a1 68 0a 00 00       	mov    0xa68,%eax
{
 ...
 60f:	5b                   	pop    %ebx
  freep = p;
 610:	a3 68 0a 00 00       	mov    %eax,0xa68
}
 615:	5e                   	pop    %esi
 616:	5f                   	pop    %edi
 617:	5d                   	pop    %ebp
 ...
 626:	72 ce                	jb     5f6 <free+0x26>
{
 ...
 647:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 64a:	a3 68 0a 00 00       	mov    %eax,0xa68
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6ab:	3b 05 68 0a 00 00    	cmp    0xa68,%eax
