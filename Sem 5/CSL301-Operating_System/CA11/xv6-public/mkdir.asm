 ...
 3c8:	89 d1                	mov    %edx,%ecx
{
 ...
 3fb:	0f b6 92 fc 07 00 00 	movzbl 0x7fc(%edx),%edx
 ...
 469:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 4d4:	ff 24 85 a4 07 00 00 	jmp    *0x7a4(,%eax,4)
 ...
 5f1:	a1 a8 0a 00 00       	mov    0xaa8,%eax
{
 ...
 62f:	5b                   	pop    %ebx
  freep = p;
 630:	a3 a8 0a 00 00       	mov    %eax,0xaa8
}
 635:	5e                   	pop    %esi
 636:	5f                   	pop    %edi
 637:	5d                   	pop    %ebp
 ...
 646:	72 ce                	jb     616 <free+0x26>
{
 ...
 667:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 66a:	a3 a8 0a 00 00       	mov    %eax,0xaa8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6cb:	3b 05 a8 0a 00 00    	cmp    0xaa8,%eax
