...
_tlbrun:     file format elf32-i386
...
int main(int argc, char *argv[]) {
  ...
  28:	c7 45 e4 0b 00 00 00 	movl   $0xb,-0x1c(%ebp)
    int trials = 5000000;

    // page faults before run
    int faults_before = getpagefaults();
  2f:	e8 27 04 00 00       	call   45b <getpagefaults>
  34:	89 45 e0             	mov    %eax,-0x20(%ebp)
    uint start = uptime();
  37:	e8 cf 03 00 00       	call   40b <uptime>
  ...
  44:	c1 e0 0c             	shl    $0xc,%eax
  47:	50                   	push   %eax
  48:	e8 ae 03 00 00       	call   3fb <sbrk>
    if (arr == (void *) -1) {
  ...
  55:	0f 84 bb 00 00 00    	je     116 <main+0x116>
      exit();
    }
  ...
  5b:	89 d9                	mov    %ebx,%ecx
  5d:	bf 40 4b 4c 00       	mov    $0x4c4b40,%edi
  62:	c1 e9 1f             	shr    $0x1f,%ecx
  65:	01 d9                	add    %ebx,%ecx
  67:	d1 f9                	sar    $1,%ecx
  69:	c1 e1 0a             	shl    $0xa,%ecx
  6c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  70:	83 fb 01             	cmp    $0x1,%ebx
  73:	0f 8e 92 00 00 00    	jle    10b <main+0x10b>
  79:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  80:	8d 41 ff             	lea    -0x1(%ecx),%eax
        arr[i] += 1;   // this "touch" causes page faults on first access
  83:	83 02 01             	addl   $0x1,(%edx)
  86:	c1 e8 0a             	shr    $0xa,%eax
  89:	83 e0 01             	and    $0x1,%eax
  8c:	89 c6                	mov    %eax,%esi
      for (i = 0; i < (numpages / 2) * jump; i += jump) {
  8e:	b8 00 04 00 00       	mov    $0x400,%eax
  93:	39 c8                	cmp    %ecx,%eax
  95:	7d 2e                	jge    c5 <main+0xc5>
  97:	85 f6                	test   %esi,%esi
  99:	74 15                	je     b0 <main+0xb0>
  9b:	b8 00 08 00 00       	mov    $0x800,%eax
        arr[i] += 1;   // this "touch" causes page faults on first access
  a0:	83 82 00 10 00 00 01 	addl   $0x1,0x1000(%edx)
      for (i = 0; i < (numpages / 2) * jump; i += jump) {
  a7:	39 c8                	cmp    %ecx,%eax
  a9:	7d 1a                	jge    c5 <main+0xc5>
  ab:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
        arr[i] += 1;   // this "touch" causes page faults on first access
  b0:	83 04 82 01          	addl   $0x1,(%edx,%eax,4)
  b4:	83 84 82 00 10 00 00 	addl   $0x1,0x1000(%edx,%eax,4)
  bb:	01 
      for (i = 0; i < (numpages / 2) * jump; i += jump) {
  bc:	05 00 08 00 00       	add    $0x800,%eax
  c1:	39 c8                	cmp    %ecx,%eax
  c3:	7c eb                	jl     b0 <main+0xb0>
    for (t = 0; t < trials; t++) {
  c5:	83 ef 01             	sub    $0x1,%edi
  c8:	75 b6                	jne    80 <main+0x80>
      }
    }

    uint end = uptime();
  ca:	e8 3c 03 00 00       	call   40b <uptime>
  cf:	89 c6                	mov    %eax,%esi
    int faults_after = getpagefaults();
  d1:	e8 85 03 00 00       	call   45b <getpagefaults>

    // report results
    printf(1,"%d\t\t%d\t%d\t%d\n",
  d6:	8b 7d e0             	mov    -0x20(%ebp),%edi
  d9:	83 ec 08             	sub    $0x8,%esp
  dc:	29 f8                	sub    %edi,%eax
  de:	50                   	push   %eax
  df:	8b 45 dc             	mov    -0x24(%ebp),%eax
  e2:	29 c6                	sub    %eax,%esi
  e4:	56                   	push   %esi
  e5:	68 40 4b 4c 00       	push   $0x4c4b40
  ea:	53                   	push   %ebx
  for (int numpages = 1; numpages <= MAXPAGES; numpages *= 2) {
  eb:	01 db                	add    %ebx,%ebx
    printf(1,"%d\t\t%d\t%d\t%d\n",
  ed:	68 55 08 00 00       	push   $0x855
  f2:	6a 01                	push   $0x1
  f4:	e8 17 04 00 00       	call   510 <printf>
  for (int numpages = 1; numpages <= MAXPAGES; numpages *= 2) {
  f9:	83 c4 20             	add    $0x20,%esp
  fc:	83 6d e4 01          	subl   $0x1,-0x1c(%ebp)
 100:	0f 85 29 ff ff ff    	jne    2f <main+0x2f>
      end - start,
  ...
  exit();
 106:	e8 68 02 00 00       	call   373 <exit>
    for (t = 0; t < trials; t++) {
 10b:	83 ef 01             	sub    $0x1,%edi
 10e:	0f 85 5c ff ff ff    	jne    70 <main+0x70>
 114:	eb b4                	jmp    ca <main+0xca>
      printf(1,"sbrk failed for %d pages\n", numpages);
 116:	50                   	push   %eax
 117:	53                   	push   %ebx
 118:	68 3b 08 00 00       	push   $0x83b
 11d:	6a 01                	push   $0x1
 11f:	e8 ec 03 00 00       	call   510 <printf>
      exit();
 124:	e8 4a 02 00 00       	call   373 <exit>
...
00000463 <twostrike>:
SYSCALL(twostrike)
 463:	b8 23 00 00 00       	mov    $0x23,%eax
 468:	cd 40                	int    $0x40
 46a:	c3                   	ret
 ...
 478:	89 d1                	mov    %edx,%ecx
{
 ...
 4ab:	0f b6 92 c4 08 00 00 	movzbl 0x8c4(%edx),%edx
 ...
 4e6:	50                   	push   %eax
 4e7:	56                   	push   %esi
 4e8:	e8 a6 fe ff ff       	call   393 <write>
  while(--i >= 0)
 ...
 519:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 550:	50                   	push   %eax
 551:	57                   	push   %edi
 552:	e8 3c fe ff ff       	call   393 <write>
 ...
 584:	ff 24 85 6c 08 00 00 	jmp    *0x86c(,%eax,4)
 ...
 5c1:	52                   	push   %edx
 5c2:	57                   	push   %edi
 5c3:	e8 cb fd ff ff       	call   393 <write>
        putc(fd, c);
 ...
 66a:	52                   	push   %edx
 66b:	57                   	push   %edi
 66c:	e8 22 fd ff ff       	call   393 <write>
        ap++;
 ...
 690:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 695:	bb 63 08 00 00       	mov    $0x863,%ebx
...
free(void *ap)
{
 ...
 6a1:	a1 70 0b 00 00       	mov    0xb70,%eax
{
 ...
 6df:	5b                   	pop    %ebx
  freep = p;
 6e0:	a3 70 0b 00 00       	mov    %eax,0xb70
}
 6e5:	5e                   	pop    %esi
 6e6:	5f                   	pop    %edi
 6e7:	5d                   	pop    %ebp
 ...
 6f6:	72 ce                	jb     6c6 <free+0x26>
{
 ...
 717:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 71a:	a3 70 0b 00 00       	mov    %eax,0xb70
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 15 70 0b 00 00    	mov    0xb70,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 77b:	3b 05 70 0b 00 00    	cmp    0xb70,%eax
 ...
 79e:	e8 fd fe ff ff       	call   6a0 <free>
  return freep;
 7a3:	8b 15 70 0b 00 00    	mov    0xb70,%edx
 ...
 7cc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7cf:	89 15 70 0b 00 00    	mov    %edx,0xb70
}
 ...
 7e7:	0b 00 00 
    base.s.size = 0;
 7ea:	b8 74 0b 00 00       	mov    $0xb74,%eax
    base.s.ptr = freep = prevp = &base;
 7ef:	c7 05 74 0b 00 00 74 	movl   $0xb74,0xb74
 7f6:	0b 00 00 
    base.s.size = 0;
