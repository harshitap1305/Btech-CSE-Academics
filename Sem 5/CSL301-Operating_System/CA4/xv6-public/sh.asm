...
fork1(void)
{
  ...
  exit();
     ...
     10b:	68 60 14 00 00       	push   $0x1460
     110:	6a 02                	push   $0x2
...
00000170 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     179:	68 54 14 00 00       	push   $0x1454
     17e:	6a 02                	push   $0x2
...
000001b0 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     1c9:	ff 24 85 10 15 00 00 	jmp    *0x1510(,%eax,4)
    if(fork1() == 0)
...
if(strcmp(ecmd->argv[0], "touch") == 0){
     1e9:	52                   	push   %edx
     1ea:	52                   	push   %edx
     1eb:	68 7e 13 00 00       	push   $0x137e
     1f0:	50                   	push   %eax
  ...
  exit(); 
    ...
    panic("runcmd");
     ...
     2d7:	68 77 13 00 00       	push   $0x1377
     2dc:	e8 8f fe ff ff       	call   170 <panic>
      printf(2, "open %s failed\n", rcmd->file);
     2e1:	51                   	push   %ecx
     2e2:	ff 73 08             	push   0x8(%ebx)
     2e5:	68 d6 13 00 00       	push   $0x13d6
     2ea:	6a 02                	push   $0x2
     2ec:	e8 6f 0d 00 00       	call   1060 <printf>
      exit();
     2f1:	e8 dd 0b 00 00       	call   ed3 <exit>
      panic("pipe");
     2f6:	83 ec 0c             	sub    $0xc,%esp
     2f9:	68 e6 13 00 00       	push   $0x13e6
    ...
    printf(2, "touch: missing file operand\n");
     331:	51                   	push   %ecx
     332:	51                   	push   %ecx
     333:	68 84 13 00 00       	push   $0x1384
     338:	6a 02                	push   $0x2
     33a:	e8 21 0d 00 00       	call   1060 <printf>
    exit();
     33f:	e8 8f 0b 00 00       	call   ed3 <exit>
if(strcmp(ecmd->argv[0], "help") == 0){
     344:	51                   	push   %ecx
     345:	51                   	push   %ecx
     346:	68 ba 13 00 00       	push   $0x13ba
  ...
  printf(2, "help - show this help\n");
     35a:	53                   	push   %ebx
     35b:	53                   	push   %ebx
     35c:	68 bf 13 00 00       	push   $0x13bf
     361:	6a 02                	push   $0x2
     363:	e8 f8 0c 00 00       	call   1060 <printf>
  printf(2, "touch <file> - create new file\n");
     368:	58                   	pop    %eax
     369:	5a                   	pop    %edx
     36a:	68 78 14 00 00       	push   $0x1478
     36f:	6a 02                	push   $0x2
     371:	e8 ea 0c 00 00       	call   1060 <printf>
  printf(2, "press ctrl+A then X - exit xv6 shell\n");
     376:	59                   	pop    %ecx
     377:	5b                   	pop    %ebx
     378:	68 98 14 00 00       	push   $0x1498
     37d:	6a 02                	push   $0x2
     37f:	e8 dc 0c 00 00       	call   1060 <printf>
  printf(2, "teststrrev - Prints your name in reverse\n");
     384:	58                   	pop    %eax
     385:	5a                   	pop    %edx
     386:	68 c0 14 00 00       	push   $0x14c0
     38b:	6a 02                	push   $0x2
     38d:	e8 ce 0c 00 00       	call   1060 <printf>
  exit();
    ...
    printf(2, "touch: cannot create %s\n", ecmd->argv[1]);
     ...
     3c1:	68 a1 13 00 00       	push   $0x13a1
     3c6:	6a 02                	push   $0x2
     3c8:	e8 93 0c 00 00       	call   1060 <printf>
    exit();
    ...
    printf(2, "Unknown command or exec failed: %s\n", ecmd->argv[0]);
     ...
     3e6:	68 ec 14 00 00       	push   $0x14ec
     3eb:	6a 02                	push   $0x2
     3ed:	e8 6e 0c 00 00       	call   1060 <printf>
    break;
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     487:	6a 0c                	push   $0xc
     489:	e8 f2 0d 00 00       	call   1280 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     4c7:	6a 0c                	push   $0xc
     4c9:	e8 b2 0d 00 00       	call   1280 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     507:	6a 08                	push   $0x8
     509:	e8 72 0d 00 00       	call   1280 <malloc>
  memset(cmd, 0, sizeof(*cmd));
     ...
     539:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     55d:	50                   	push   %eax
     55e:	68 68 1b 00 00       	push   $0x1b68
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     5ad:	50                   	push   %eax
     5ae:	68 68 1b 00 00       	push   $0x1b68
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     606:	50                   	push   %eax
     607:	68 60 1b 00 00       	push   $0x1b60
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     625:	50                   	push   %eax
     626:	68 68 1b 00 00       	push   $0x1b68
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     6cd:	50                   	push   %eax
     6ce:	68 68 1b 00 00       	push   $0x1b68
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     733:	68 08 14 00 00       	push   $0x1408
     738:	53                   	push   %ebx
     739:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     790:	6a 18                	push   $0x18
     792:	e8 e9 0a 00 00       	call   1280 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  cmd = malloc(sizeof(*cmd));
     7ef:	6a 18                	push   $0x18
     7f1:	e8 8a 0a 00 00       	call   1280 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  return cmd;
     ...
     84e:	68 eb 13 00 00       	push   $0x13eb
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     86f:	68 0b 14 00 00       	push   $0x140b
     874:	56                   	push   %esi
     875:	53                   	push   %ebx
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     88b:	6a 54                	push   $0x54
     88d:	e8 ee 09 00 00       	call   1280 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     8d6:	68 22 14 00 00       	push   $0x1422
     8db:	56                   	push   %esi
     8dc:	53                   	push   %ebx
    ...
    if(argc >= MAXARGS)
     ...
     920:	68 14 14 00 00       	push   $0x1414
  ...
  cmd->eargv[argc] = 0;
     ...
     969:	68 0d 14 00 00       	push   $0x140d
...
00000980 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     999:	68 27 14 00 00       	push   $0x1427
  cmd = parseexec(ps, es);
  ...
  cmd = malloc(sizeof(*cmd));
     9dd:	e8 9e 08 00 00       	call   1280 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
00000a10 <parseline>:
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     a42:	e8 39 08 00 00       	call   1280 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while(peek(ps, es, "&")){
     ...
     a6b:	68 29 14 00 00       	push   $0x1429
     a70:	57                   	push   %edi
     a71:	56                   	push   %esi
  ...
  if(peek(ps, es, ";")){
     ...
     a81:	68 25 14 00 00       	push   $0x1425
     a86:	57                   	push   %edi
     a87:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     abd:	e8 be 07 00 00       	call   1280 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
00000af0 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     aff:	68 0b 14 00 00       	push   $0x140b
     b04:	56                   	push   %esi
     b05:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     ...
     b29:	68 47 14 00 00       	push   $0x1447
  cmd = parseline(ps, es);
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     b95:	ff 24 85 28 15 00 00 	jmp    *0x1528(,%eax,4)
     ...
     c25:	8d 7d 08             	lea    0x8(%ebp),%edi
{
  ...
  peek(&s, es, "");
     ...
     c43:	68 e5 13 00 00       	push   $0x13e5
  cmd = parseline(&s, es);
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     c6e:	52                   	push   %edx
     c6f:	50                   	push   %eax
     c70:	68 49 14 00 00       	push   $0x1449
     c75:	6a 02                	push   $0x2
     c77:	e8 e4 03 00 00       	call   1060 <printf>
    panic("syntax");
     c7c:	c7 04 24 0d 14 00 00 	movl   $0x140d,(%esp)
     ...
     fc8:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     ffb:	0f b6 92 98 15 00 00 	movzbl 0x1598(%edx),%edx
  ...
  write(fd, &c, 1);
    ...
    1036:	50                   	push   %eax
    1037:	56                   	push   %esi
    1038:	e8 b6 fe ff ff       	call   ef3 <write>
  while(--i >= 0)
    ...
    1069:	8b 75 0c             	mov    0xc(%ebp),%esi
{
  ...
  write(fd, &c, 1);
    ...
    10a0:	50                   	push   %eax
    10a1:	57                   	push   %edi
    10a2:	e8 4c fe ff ff       	call   ef3 <write>
  ...
  for(i = 0; fmt[i]; i++){
    ...
    10d4:	ff 24 85 40 15 00 00 	jmp    *0x1540(,%eax,4)
  ...
  write(fd, &c, 1);
    ...
    1100:	57                   	push   %edi
    1101:	e8 ed fd ff ff       	call   ef3 <write>
    ...
    1111:	52                   	push   %edx
    1112:	57                   	push   %edi
    1113:	e8 db fd ff ff       	call   ef3 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    117b:	53                   	push   %ebx
    117c:	57                   	push   %edi
    117d:	e8 71 fd ff ff       	call   ef3 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    ...
    11ba:	52                   	push   %edx
    11bb:	57                   	push   %edi
    11bc:	e8 32 fd ff ff       	call   ef3 <write>
        ap++;
  ...
  write(fd, &c, 1);
    ...
    11e0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
    11e5:	bb 6e 14 00 00       	mov    $0x146e,%ebx
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    11f1:	a1 e4 1b 00 00       	mov    0x1be4,%eax
{
  ...
  freep = p;
    ...
    122f:	5b                   	pop    %ebx
  freep = p;
    1230:	a3 e4 1b 00 00       	mov    %eax,0x1be4
}
    1235:	5e                   	pop    %esi
    1236:	5f                   	pop    %edi
    1237:	5d                   	pop    %ebp
    ...
    1246:	72 ce                	jb     1216 <free+0x26>
{
  ...
  freep = p;
    126a:	a3 e4 1b 00 00       	mov    %eax,0x1be4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    128c:	8b 15 e4 1b 00 00    	mov    0x1be4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    12cb:	3b 05 e4 1b 00 00    	cmp    0x1be4,%eax
    12d1:	75 ed                	jne    12c0 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
    12d3:	83 ec 0c             	sub    $0xc,%esp
    12d6:	56                   	push   %esi
    12d7:	e8 7f fc ff ff       	call   f5b <sbrk>
  if(p == (char*)-1)
  ...
  return freep;
    12f3:	8b 15 e4 1b 00 00    	mov    0x1be4,%edx
    ...
    131c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    131f:	89 15 e4 1b 00 00    	mov    %edx,0x1be4
}
    ...
    132f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
    1330:	c7 05 e4 1b 00 00 e8 	movl   $0x1be8,0x1be4
    1337:	1b 00 00 
    base.s.size = 0;
    133a:	b8 e8 1b 00 00       	mov    $0x1be8,%eax
    base.s.ptr = freep = prevp = &base;
    133f:	c7 05 e8 1b 00 00 e8 	movl   $0x1be8,0x1be8
    1346:	1b 00 00 
    base.s.size = 0;
    1349:	c7 05 ec 1b 00 00 00 	movl   $0x0,0x1bec
    1350:	00 00 00 
    if(p->s.size >= nunits){
