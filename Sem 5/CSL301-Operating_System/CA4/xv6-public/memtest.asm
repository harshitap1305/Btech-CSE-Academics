...
printf(1, "Virtual pages: %d \n", numvp());
  11:	e8 55 03 00 00       	call   36b <numvp>
...
printf(1, "Physical pages: %d \n", numpp());
  26:	e8 48 03 00 00       	call   373 <numpp>
  2b:	83 c4 0c             	add    $0xc,%esp
  2e:	50                   	push   %eax
  2f:	68 4c 07 00 00       	push   $0x74c
  34:	6a 01                	push   $0x1
  36:	e8 f5 03 00 00       	call   430 <printf>
printf(1, "Page table pages: %d \n", getptsize());
  3b:	e8 3b 03 00 00       	call   37b <getptsize>
  40:	83 c4 0c             	add    $0xc,%esp
  43:	50                   	push   %eax
  44:	68 61 07 00 00       	push   $0x761
  49:	6a 01                	push   $0x1
  4b:	e8 e0 03 00 00       	call   430 <printf>
exit();
  50:	e8 4e 02 00 00       	call   2a3 <exit>
  55:	66 90                	xchg   %ax,%ax
  57:	66 90                	xchg   %ax,%ax
  59:	66 90                	xchg   %ax,%ax
  5b:	66 90                	xchg   %ax,%ax
 ...
 398:	89 d1                	mov    %edx,%ecx
{
 ...
 3cb:	0f b6 92 d8 07 00 00 	movzbl 0x7d8(%edx),%edx
 ...
 439:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 4a4:	ff 24 85 80 07 00 00 	jmp    *0x780(,%eax,4)
 ...
 5b0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5b5:	bb 78 07 00 00       	mov    $0x778,%ebx
 ...
 5c1:	a1 74 0a 00 00       	mov    0xa74,%eax
{
 ...
 5ff:	5b                   	pop    %ebx
  freep = p;
 600:	a3 74 0a 00 00       	mov    %eax,0xa74
}
 605:	5e                   	pop    %esi
 606:	5f                   	pop    %edi
 607:	5d                   	pop    %ebp
 ...
 616:	72 ce                	jb     5e6 <free+0x26>
{
 ...
 637:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 63a:	a3 74 0a 00 00       	mov    %eax,0xa74
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 15 74 0a 00 00    	mov    0xa74,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 69b:	3b 05 74 0a 00 00    	cmp    0xa74,%eax
 ...
 6be:	e8 fd fe ff ff       	call   5c0 <free>
  return freep;
 6c3:	8b 15 74 0a 00 00    	mov    0xa74,%edx
 ...
 6ec:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6ef:	89 15 74 0a 00 00    	mov    %edx,0xa74
}
 ...
 6ff:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 700:	c7 05 74 0a 00 00 78 	movl   $0xa78,0xa74
 707:	0a 00 00 
    base.s.size = 0;
 70a:	b8 78 0a 00 00       	mov    $0xa78,%eax
    base.s.ptr = freep = prevp = &base;
 70f:	c7 05 78 0a 00 00 78 	movl   $0xa78,0xa78
 716:	0a 00 00 
    base.s.size = 0;
 719:	c7 05 7c 0a 00 00 00 	movl   $0x0,0xa7c
 720:	00 00 00 
    if(p->s.size >= nunits){
