   ...
   f:	31 db                	xor    %ebx,%ebx
{
  ...
  d8:	50                   	push   %eax
  d9:	53                   	push   %ebx
  da:	68 61 08 00 00       	push   $0x861
  df:	6a 01                	push   $0x1
  e1:	e8 da 03 00 00       	call   4c0 <printf>
      exit();
 ...
 428:	89 d1                	mov    %edx,%ecx
{
 ...
 45b:	0f b6 92 e0 08 00 00 	movzbl 0x8e0(%edx),%edx
 ...
 4c9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 534:	ff 24 85 88 08 00 00 	jmp    *0x888(,%eax,4)
 ...
 640:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 645:	bb 7e 08 00 00       	mov    $0x87e,%ebx
...
free(void *ap)
{
 ...
 651:	a1 84 0b 00 00       	mov    0xb84,%eax
{
 ...
 68f:	5b                   	pop    %ebx
  freep = p;
 690:	a3 84 0b 00 00       	mov    %eax,0xb84
}
 695:	5e                   	pop    %esi
 696:	5f                   	pop    %edi
 697:	5d                   	pop    %ebp
 ...
 6a6:	72 ce                	jb     676 <free+0x26>
{
 ...
 6c7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ca:	a3 84 0b 00 00       	mov    %eax,0xb84
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 15 84 0b 00 00    	mov    0xb84,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 72b:	3b 05 84 0b 00 00    	cmp    0xb84,%eax
 ...
 74e:	e8 fd fe ff ff       	call   650 <free>
  return freep;
 753:	8b 15 84 0b 00 00    	mov    0xb84,%edx
 ...
 77c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 77f:	89 15 84 0b 00 00    	mov    %edx,0xb84
}
 ...
 78f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 790:	c7 05 84 0b 00 00 88 	movl   $0xb88,0xb84
 797:	0b 00 00 
    base.s.size = 0;
 79a:	b8 88 0b 00 00       	mov    $0xb88,%eax
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 88 0b 00 00 88 	movl   $0xb88,0xb88
 7a6:	0b 00 00 
    base.s.size = 0;
 7a9:	c7 05 8c 0b 00 00 00 	movl   $0x0,0xb8c
 7b0:	00 00 00 
    if(p->s.size >= nunits){
