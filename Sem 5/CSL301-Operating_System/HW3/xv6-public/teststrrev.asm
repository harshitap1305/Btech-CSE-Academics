...
int main(void) {
  ...
  6e:	53                   	push   %ebx
  6f:	68 64 07 00 00       	push   $0x764
  74:	6a 01                	push   $0x1
  76:	e8 d5 03 00 00       	call   450 <printf>
  exit();
 ...
 459:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5d0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5d5:	bb 6f 07 00 00       	mov    $0x76f,%ebx
 ...
 5e1:	a1 70 0a 00 00       	mov    0xa70,%eax
{
 ...
 61f:	5b                   	pop    %ebx
  freep = p;
 620:	a3 70 0a 00 00       	mov    %eax,0xa70
}
 625:	5e                   	pop    %esi
 626:	5f                   	pop    %edi
 627:	5d                   	pop    %ebp
 ...
 636:	72 ce                	jb     606 <free+0x26>
{
 ...
 657:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 65a:	a3 70 0a 00 00       	mov    %eax,0xa70
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6bb:	3b 05 70 0a 00 00    	cmp    0xa70,%eax
 ...
 6de:	e8 fd fe ff ff       	call   5e0 <free>
  return freep;
 6e3:	8b 15 70 0a 00 00    	mov    0xa70,%edx
 ...
 727:	0a 00 00 
    base.s.size = 0;
 72a:	b8 74 0a 00 00       	mov    $0xa74,%eax
    base.s.ptr = freep = prevp = &base;
 72f:	c7 05 74 0a 00 00 74 	movl   $0xa74,0xa74
 736:	0a 00 00 
    base.s.size = 0;
 739:	c7 05 78 0a 00 00 00 	movl   $0x0,0xa78
 740:	00 00 00 
    if(p->s.size >= nunits){
