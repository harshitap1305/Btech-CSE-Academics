 ...
 439:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5b0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5b5:	bb 45 07 00 00       	mov    $0x745,%ebx
...
free(void *ap)
{
 ...
 5c1:	a1 6c 0a 00 00       	mov    0xa6c,%eax
{
 ...
 5ff:	5b                   	pop    %ebx
  freep = p;
 600:	a3 6c 0a 00 00       	mov    %eax,0xa6c
}
 605:	5e                   	pop    %esi
 606:	5f                   	pop    %edi
 607:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 15 6c 0a 00 00    	mov    0xa6c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 69b:	3b 05 6c 0a 00 00    	cmp    0xa6c,%eax
 ...
 6be:	e8 fd fe ff ff       	call   5c0 <free>
  return freep;
 6c3:	8b 15 6c 0a 00 00    	mov    0xa6c,%edx
 ...
 707:	0a 00 00 
    base.s.size = 0;
 70a:	b8 70 0a 00 00       	mov    $0xa70,%eax
    base.s.ptr = freep = prevp = &base;
 70f:	c7 05 70 0a 00 00 70 	movl   $0xa70,0xa70
 716:	0a 00 00 
    base.s.size = 0;
 719:	c7 05 74 0a 00 00 00 	movl   $0x0,0xa74
 720:	00 00 00 
    if(p->s.size >= nunits){
