...
fork1(void)
{
  ...
  exit();
     ...
     10b:	68 12 13 00 00       	push   $0x1312
     110:	6a 02                	push   $0x2
    ...
    panic("fork");
     ...
     122:	68 6c 12 00 00       	push   $0x126c
...
00000170 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     179:	68 06 13 00 00       	push   $0x1306
     17e:	6a 02                	push   $0x2
...
00000190 <fork1>:
{
  ...
  return pid;
    ...
    panic("fork");
     ...
     1a5:	68 6c 12 00 00       	push   $0x126c
...
000001b0 <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     1e9:	68 78 12 00 00       	push   $0x1278
     1ee:	6a 02                	push   $0x2
    ...
    panic("runcmd");
     ...
     2d2:	68 98 12 00 00       	push   $0x1298
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     663:	68 ba 12 00 00       	push   $0x12ba
     668:	53                   	push   %ebx
     669:	56                   	push   %esi
  ...
  return cmd;
     ...
     77e:	68 9d 12 00 00       	push   $0x129d
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     79f:	68 bd 12 00 00       	push   $0x12bd
     7a4:	56                   	push   %esi
     7a5:	53                   	push   %ebx
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     806:	68 d4 12 00 00       	push   $0x12d4
     80b:	56                   	push   %esi
     80c:	53                   	push   %ebx
    ...
    if(argc >= MAXARGS)
     ...
     850:	68 c6 12 00 00       	push   $0x12c6
  ...
  cmd->eargv[argc] = 0;
     ...
     899:	68 bf 12 00 00       	push   $0x12bf
...
000008b0 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     8c9:	68 d9 12 00 00       	push   $0x12d9
  cmd = parseexec(ps, es);
...
00000940 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     99b:	68 db 12 00 00       	push   $0x12db
     9a0:	57                   	push   %edi
     9a1:	56                   	push   %esi
  ...
  if(peek(ps, es, ";")){
     ...
     9b1:	68 d7 12 00 00       	push   $0x12d7
     9b6:	57                   	push   %edi
     9b7:	56                   	push   %esi
...
00000a20 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     a2f:	68 bd 12 00 00       	push   $0x12bd
     a34:	56                   	push   %esi
     a35:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     ...
     a59:	68 f9 12 00 00       	push   $0x12f9
  cmd = parseline(ps, es);
     ...
     b55:	8d 7d 08             	lea    0x8(%ebp),%edi
{
  ...
  peek(&s, es, "");
     ...
     b73:	68 87 12 00 00       	push   $0x1287
  cmd = parseline(&s, es);
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     b9e:	52                   	push   %edx
     b9f:	50                   	push   %eax
     ba0:	68 fb 12 00 00       	push   $0x12fb
     ba5:	6a 02                	push   $0x2
     ba7:	e8 a4 03 00 00       	call   f50 <printf>
    panic("syntax");
     bac:	c7 04 24 bf 12 00 00 	movl   $0x12bf,(%esp)
     ...
     eb8:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     eeb:	0f b6 92 b0 13 00 00 	movzbl 0x13b0(%edx),%edx
     ...
     f59:	8b 75 0c             	mov    0xc(%ebp),%esi
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     fc4:	ff 24 85 58 13 00 00 	jmp    *0x1358(,%eax,4)
  ...
  write(fd, &c, 1);
    ...
    10d0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
    10d5:	bb 20 13 00 00       	mov    $0x1320,%ebx
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    10e1:	a1 04 1a 00 00       	mov    0x1a04,%eax
{
  ...
  freep = p;
    ...
    111f:	5b                   	pop    %ebx
  freep = p;
    1120:	a3 04 1a 00 00       	mov    %eax,0x1a04
}
    1125:	5e                   	pop    %esi
    1126:	5f                   	pop    %edi
    1127:	5d                   	pop    %ebp
    ...
    1136:	72 ce                	jb     1106 <free+0x26>
{
  ...
  freep = p;
    115a:	a3 04 1a 00 00       	mov    %eax,0x1a04
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    117c:	8b 15 04 1a 00 00    	mov    0x1a04,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    11bb:	3b 05 04 1a 00 00    	cmp    0x1a04,%eax
  ...
  return freep;
    11e3:	8b 15 04 1a 00 00    	mov    0x1a04,%edx
    ...
    120c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    120f:	89 15 04 1a 00 00    	mov    %edx,0x1a04
}
    ...
    121f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
    1220:	c7 05 04 1a 00 00 08 	movl   $0x1a08,0x1a04
    1227:	1a 00 00 
    base.s.size = 0;
    122a:	b8 08 1a 00 00       	mov    $0x1a08,%eax
    base.s.ptr = freep = prevp = &base;
    122f:	c7 05 08 1a 00 00 08 	movl   $0x1a08,0x1a08
    1236:	1a 00 00 
    base.s.size = 0;
    1239:	c7 05 0c 1a 00 00 00 	movl   $0x0,0x1a0c
    1240:	00 00 00 
    if(p->s.size >= nunits){
