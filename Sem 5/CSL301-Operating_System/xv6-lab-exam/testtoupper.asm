   ...
   f:	8d 5d d8             	lea    -0x28(%ebp),%ebx
{
  ...
  64:	50                   	push   %eax
  65:	53                   	push   %ebx
  66:	e8 f8 02 00 00       	call   363 <toupper>
  printf(1,"After: %s\n",stringArray);
  6b:	83 c4 0c             	add    $0xc,%esp
  6e:	53                   	push   %ebx
  6f:	68 24 07 00 00       	push   $0x724
  74:	6a 01                	push   $0x1
  76:	e8 95 03 00 00       	call   410 <printf>
  exit();
 ...
 378:	89 d1                	mov    %edx,%ecx
{
 ...
 3ab:	0f b6 92 90 07 00 00 	movzbl 0x790(%edx),%edx
 ...
 419:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 484:	ff 24 85 38 07 00 00 	jmp    *0x738(,%eax,4)
 ...
 590:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 595:	bb 2f 07 00 00       	mov    $0x72f,%ebx
 ...
 5a1:	a1 30 0a 00 00       	mov    0xa30,%eax
{
 ...
 5df:	5b                   	pop    %ebx
  freep = p;
 5e0:	a3 30 0a 00 00       	mov    %eax,0xa30
}
 5e5:	5e                   	pop    %esi
 5e6:	5f                   	pop    %edi
 5e7:	5d                   	pop    %ebp
 ...
 5f6:	72 ce                	jb     5c6 <free+0x26>
{
 ...
 617:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 61a:	a3 30 0a 00 00       	mov    %eax,0xa30
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 639:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 63c:	8b 15 30 0a 00 00    	mov    0xa30,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 67b:	3b 05 30 0a 00 00    	cmp    0xa30,%eax
 ...
 69e:	e8 fd fe ff ff       	call   5a0 <free>
  return freep;
 6a3:	8b 15 30 0a 00 00    	mov    0xa30,%edx
 ...
 6e7:	0a 00 00 
    base.s.size = 0;
 6ea:	b8 34 0a 00 00       	mov    $0xa34,%eax
    base.s.ptr = freep = prevp = &base;
 6ef:	c7 05 34 0a 00 00 34 	movl   $0xa34,0xa34
 6f6:	0a 00 00 
    base.s.size = 0;
 6f9:	c7 05 38 0a 00 00 00 	movl   $0x0,0xa38
 700:	00 00 00 
    if(p->s.size >= nunits){
