...
_testflags:     file format elf32-i386
...
main(void)
{
  ...
  // First set
  setflag(12340920);
  11:	68 b8 4e bc 00       	push   $0xbc4eb8
  16:	e8 30 03 00 00       	call   34b <setflag>
  printf(1, "After first set: %d\n", getflag());
  1b:	e8 33 03 00 00       	call   353 <getflag>
  20:	83 c4 0c             	add    $0xc,%esp
  23:	50                   	push   %eax
  24:	68 48 07 00 00       	push   $0x748
  29:	6a 01                	push   $0x1
  2b:	e8 10 04 00 00       	call   440 <printf>

  // Second set
  setflag(12904321);
  30:	c7 04 24 81 e7 c4 00 	movl   $0xc4e781,(%esp)
  37:	e8 0f 03 00 00       	call   34b <setflag>
  printf(1, "After second set: %d\n", getflag());
  3c:	e8 12 03 00 00       	call   353 <getflag>
  41:	83 c4 0c             	add    $0xc,%esp
  44:	50                   	push   %eax
  45:	68 5d 07 00 00       	push   $0x75d
  4a:	6a 01                	push   $0x1
 ...
 449:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5c0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5c5:	bb 73 07 00 00       	mov    $0x773,%ebx
 ...
 5d1:	a1 70 0a 00 00       	mov    0xa70,%eax
{
 ...
 60f:	5b                   	pop    %ebx
  freep = p;
 610:	a3 70 0a 00 00       	mov    %eax,0xa70
}
 615:	5e                   	pop    %esi
 616:	5f                   	pop    %edi
 617:	5d                   	pop    %ebp
 ...
 626:	72 ce                	jb     5f6 <free+0x26>
{
 ...
 647:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 64a:	a3 70 0a 00 00       	mov    %eax,0xa70
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6ab:	3b 05 70 0a 00 00    	cmp    0xa70,%eax
